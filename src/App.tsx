...
import { generateContent, generateImage, generateAudio, generateExercise } from './services/geminiService';
import { EnglishLevel, AspectRatio, ContentMode, VocabularyItem, ExerciseData } from './types';
...
export default function App() {
  ...
  const handleGenerate = useCallback(async () => {
    ...
    try {
      ...
      // 2. Generate image, audio, and exercises in parallel
      audioPlayer.setIsAudioLoading(true);
      const [imageUrl, audioUrl, exData] = await Promise.all([
